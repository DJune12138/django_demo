...
def confirm_youai_get_link_id(request):
    return request.GET.get('payType','')

def confirm_youai(request,pay_channel):
    result_msg = 'FAILURE'
    if not pay_channel:
