# -*- coding: utf-8 -*-
#GET  http://127.0.0.1:8002/service/confirm/xingwan?serverId=14&callbackInfo=14&openId=14680065&orderId=120507224627804959449D&orderStatus=1&payType=2&amount=10&remark=hello&sign=db651e40d456c8b0972f5447173329d1
# 测试地址
# http://127.0.0.1:8002/service/confirm/xingwan?orderId=1000000316407512&postTime=1500381300&uId=458456&playerId=2097437&sdkSimpleName=apple_xingwan&custom=6%235%23xxx&goodsName=300灵玉&currency=CNY&goodsId=com.xigua.mhtx.300&queryId=20170718204500122533AC61&remoteIp=14.23.124.148&serverSign=72c52e76dc2abbddbf4f1112b53cc997&serverId=2&gameSimpleName=mhtx_ios&payTime=1500381349&payAmount=648.0
...
def confirm_xingwan_get_link_id(request):
    return request.GET.get('payType','')

def confirm_xingwan(request,pay_channel):
    result_msg = 'FAILURE'
    if not pay_channel:
    ...
    try:
        ...
        print 'confirm xingwan has Error:',e
