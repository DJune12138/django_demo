...
# 测试地址
# http://127.0.0.1:8002/service/confirm/yaxd?orderId=1000000316408514&postTime=1500381300&uId=458456&playerId=2097437&payType=apple&sdkSimpleName=apple_xingwan&custom=6%235&goodsName=300灵玉&currency=CNY&goodsId=com.xigua.mhtx.300&queryId=20170818204500122534AC31&remoteIp=14.23.124.148&serverSign=72c52e76dc2abbddbf4f1112b53cc997&serverId=2&gameSimpleName=mhtx_ios&payTime=1500381349&payAmount=648.0
...
def confirm_yaxd_get_link_id(request):
    return request.GET.get('payType','')

def confirm_yaxd(request,pay_channel):
    result_msg = 'FAILURE'
    if not pay_channel:
