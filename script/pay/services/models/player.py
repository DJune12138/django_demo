...
class Player_convert(models.Model,BaseModelMixin):
    type = models.CharField(u'登录步骤', max_length=200,db_index=True)
    player_id = models.IntegerField(u'角色id',max_length=60,db_index=True)
    account = models.CharField(u'玩家账号', max_length=200,db_index=True)
    ieme = models.CharField(u'设备标识',max_length=200, db_index=True)
    create_time = models.DateTimeField(u'创建时间', auto_now_add=True,db_index=True)
