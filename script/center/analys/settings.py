...
SERVICE_URL = 'http://10.21.210.175:8002'
...
MEDIA_ROOT = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(PROJECT_ROOT))), 'static').replace('\\', '/')
...
MIDDLEWARE_CLASSES = (
    ...
    # 'util.cachemiddleware.CacheMiddleware',
    'middleware.CustomRequestMiddleware',
    'middleware.AuthMiddleware',
    #   'debug_toolbar.middleware.DebugToolbarMiddleware',
)
INTERNAL_IPS = ('10.20.201.172', '100.100.100.1', '100.100.100.101', '10.21.210.120')
...
# 生成静态文件用的地址
STATIC_PATH = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
